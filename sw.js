...
const PRECACHE = [
  '/TEST-RIDE-FARELLONES-2/landing.html',
  '/TEST-RIDE-FARELLONES-2/index.html',
  '/TEST-RIDE-FARELLONES-2/registro.html',
  '/TEST-RIDE-FARELLONES-2/mapa.html',
  '/TEST-RIDE-FARELLONES-2/assets/ruta.js',
  '/TEST-RIDE-FARELLONES-2/manifest.json',
  '/TEST-RIDE-FARELLONES-2/icons/icon-192.png',
  '/TEST-RIDE-FARELLONES-2/icons/icon-512.png'
];
